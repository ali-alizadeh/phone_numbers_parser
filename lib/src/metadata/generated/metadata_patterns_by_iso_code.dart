...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.GY: PhoneMetadataPatterns(
    ...
    mobile: r"(?:51[01]|6\d\d|7(?:[0-5]\d|6[0-69]|70))\d{4}",
    fixedLine:
  ...
  IsoCode.HK: PhoneMetadataPatterns(
    ...
    mobile:
        r"(?:4(?:09[3-6]|44[0-35-9]|6(?:4[0-57-9]|6[0-6])|7(?:4[0-48]|6[0-5]))|5(?:25[3-7]|35[4-8]|73[0-6]|95[0-8])|6(?:26[013-8]|(?:66|78)[0-5])|70(?:7[1-8]|8[0-8])|84(?:4[0-2]|8[0-35-9])|9(?:29[013-9]|39[014-9]|59[0-467]|899))\d{4}|(?:4(?:4[0-35-9]|6[0-357-9]|7[0-35])|5(?:[1-59][0-46-9]|6[0-4689]|7[0-246-9])|6(?:0[1-9]|[13-59]\d|[268][0-57-9]|7[0-79])|70[1-59]|84[0-39]|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\d))\d{5}",
    fixedLine:
  ...
  IsoCode.SG: PhoneMetadataPatterns(
    ...
    mobile:
        r"89(?:8[02-9]|9[0-5])\d{4}|(?:8(?:0[1-9]|[1-8]\d|9[0-7])|9[0-8]\d)\d{5}",
  ...
  IsoCode.UG: PhoneMetadataPatterns(
    ...
    mobile: r"72[48]0\d{5}|7(?:[014-8]\d|2[0167]|3[06]|9[0-3589])\d{6}",
    fixedLine:
