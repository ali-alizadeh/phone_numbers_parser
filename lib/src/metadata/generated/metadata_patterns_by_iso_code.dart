...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.CZ: PhoneMetadataPatterns(
    ...
    mobile: r"(?:60[1-8]\d|7(?:0(?:[2-5]\d|60)|19[0-2]|[2379]\d\d))\d{5}",
  ...
  IsoCode.EH: PhoneMetadataPatterns(
    ...
    general: r"[5-8]\d{8}",
    mobile:
        r"(?:6(?:[0-79]\d|8[0-247-9])|7(?:[0167]\d|2[0-467]|5[0-3]|8[0-5]))\d{6}",
  ...
  IsoCode.GY: PhoneMetadataPatterns(
    ...
    mobile: r"(?:510|6\d\d|7(?:[0-5]\d|6[01]))\d{4}",
    fixedLine:
  ...
  IsoCode.IL: PhoneMetadataPatterns(
    ...
    voip:
        r"7(?:38(?:0\d|5[0-3569]|88)|8(?:33|55|77|81)\d)\d{4}|7(?:18|2[23]|3[237]|47|6[258]|7\d|82|9[2-9])\d{6}",
  ),
  ...
  IsoCode.ML: PhoneMetadataPatterns(
    ...
    nationalPrefixTransformRule: null,
    general: r"[24-9]\d{7}",
    mobile: r"2(?:0(?:01|79)|17\d)\d{4}|(?:5[01]|[679]\d|8[2-59])\d{6}",
    fixedLine:
  ...
  IsoCode.PL: PhoneMetadataPatterns(
    ...
    mobile:
        r"2131[89]\d{4}|21(?:1[013-5]|2\d|3[2-9])\d{5}|(?:45|5[0137]|6[069]|7[2389]|88)\d{7}",
    fixedLine:
  ...
  IsoCode.SG: PhoneMetadataPatterns(
    ...
    mobile: r"896[0-46-8]\d{4}|(?:8(?:0[1-9]|[1-8]\d|9[0-5])|9[0-8]\d)\d{5}",
  ...
  IsoCode.SL: PhoneMetadataPatterns(
    ...
    mobile: r"(?:25|3[0-5]|66|7[1-9]|8[08]|9[09])\d{6}",
  ...
  IsoCode.SN: PhoneMetadataPatterns(
    ...
    mobile:
        r"7(?:(?:[06-8]\d|[19]0|21)\d|5(?:0[01]|[19]0|2[25]|3[356]|[4-7]\d|8[35]))\d{5}",
  ...
  IsoCode.TJ: PhoneMetadataPatterns(
    ...
    mobile:
        r"(?:33[03-9]|4(?:1[18]|4[02-479])|81[1-9])\d{6}|(?:[09]\d|1[0-27-9]|2[0-27]|[34]0|5[05]|7[01578]|8[078])\d{7}",
    fixedLine:
  ...
  IsoCode.UG: PhoneMetadataPatterns(
    ...
    mobile: r"72[48]0\d{5}|7(?:[015-8]\d|2[067]|36|4[0-8]|9[089])\d{6}",
    fixedLine:
  ...
  IsoCode.ZA: PhoneMetadataPatterns(
    ...
    fixedLine:
        r"50[0-2]\d{6}|(?:2(?:0330|4302)|52087)0\d{3}|(?:1[0-8]|2[1-378]|3[1-69]|4\d|5[1346-8])\d{7}",
    voip:
