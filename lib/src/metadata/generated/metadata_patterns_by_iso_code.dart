...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.BD: PhoneMetadataPatterns(
    ...
    voip:
        r"96(?:0[1-69]|1[0-479]|2[278]|3[13-9]|4[013]|54|6[69]|7[78]|88)\d{6}",
  ),
  ...
  IsoCode.GY: PhoneMetadataPatterns(
    ...
    mobile: r"(?:51[01]|6\d\d|7(?:[0-5]\d|6[0-79]|[78]0))\d{4}",
    fixedLine:
  ...
  IsoCode.UG: PhoneMetadataPatterns(
    ...
    mobile: r"7280\d{5}|7(?:[014-8]\d|2[01467]|3[0167]|9[0-589])\d{6}",
    fixedLine:
