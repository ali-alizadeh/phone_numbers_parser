...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.EH: PhoneMetadataPatterns(
    ...
    general: r"[5-8]\d{8}",
    mobile:
        r"(?:6(?:[0-79]\d|8[0-247-9])|7(?:[0167]\d|2[0-467]|5[0-3]|8[0-7]))\d{6}",
  ...
  IsoCode.SG: PhoneMetadataPatterns(
    ...
    mobile: r"897[01]\d{4}|(?:8(?:0[1-9]|[1-8]\d|9[0-6])|9[0-8]\d)\d{5}",
