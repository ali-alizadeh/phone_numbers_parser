...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.CZ: PhoneMetadataPatterns(
    ...
    mobile: r"(?:60[1-8]\d|7(?:0(?:[2-5]\d|60)|19[0-4]|[2379]\d\d))\d{5}",
  ...
  IsoCode.LI: PhoneMetadataPatterns(
    ...
    mobile:
        r"(?:6(?:(?:4[5-9]|5[0-46-9])\d|6(?:[024-6]\d|[17]0|3[7-9]))\d|7(?:[37-9]\d|42|56))\d{4}",
    fixedLine:
  ...
  IsoCode.SG: PhoneMetadataPatterns(
    ...
    mobile: r"8980\d{4}|(?:8(?:0[1-9]|[1-8]\d|9[0-7])|9[0-8]\d)\d{5}",
  ...
  IsoCode.UG: PhoneMetadataPatterns(
    ...
    mobile: r"72[48]0\d{5}|7(?:[014-8]\d|2[067]|36|9[0189])\d{6}",
    fixedLine:
