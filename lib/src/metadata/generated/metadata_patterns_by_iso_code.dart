...
const metadataPatternsByIsoCode = {
  ...
  IsoCode.AU: PhoneMetadataPatterns(
    ...
    mobile:
        r"4(?:79[01]|83[0-36-9])\d{5}|4(?:[0-36]\d|4[047-9]|[58][0-24-9]|7[02-8]|9[0-47-9])\d{6}",
    fixedLine:
  ...
  IsoCode.CZ: PhoneMetadataPatterns(
    ...
    mobile:
        r"7(?:060\d|19(?:[0-5]\d|6[0-6]))\d{4}|(?:60[1-8]|7(?:0[2-5]|[2379]\d))\d{6}",
  ...
  IsoCode.HK: PhoneMetadataPatterns(
    ...
    mobile:
        r"(?:4(?:44[0-35-9]|6(?:4[0-57-9]|6[0-6])|7(?:3[0-4]|4[0-48]|6[0-5]))|5(?:35[4-8]|73[0-6]|95[0-8])|6(?:26[013-8]|(?:66|78)[0-5])|70(?:7[1-8]|8[0-8])|84(?:4[0-2]|8[0-35-9])|9(?:29[013-9]|39[014-9]|59[0-467]|899))\d{4}|(?:4(?:4[0-35-9]|6[0-357-9]|7[0-25])|5(?:[1-59][0-46-9]|6[0-4689]|7[0-246-9])|6(?:0[1-9]|[13-59]\d|[268][0-57-9]|7[0-79])|70[1-59]|84[0-39]|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\d))\d{5}",
    fixedLine:
  ...
  IsoCode.LB: PhoneMetadataPatterns(
    ...
    mobile: r"(?:(?:3|81)\d|7(?:[01]\d|6[013-9]|8[7-9]|9[0-3]))\d{5}",
    fixedLine:
